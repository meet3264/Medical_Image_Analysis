...
welcome_html = """
<div>
<h2 style="color:#333;text-align:left;">Tumor Detection Using CNN</h2>
</div>
"""
...
def Tumor_CNN():
    ...
    model_path = 'Models/Tumor_CNN.h5'
    model = tf.keras.models.load_model(model_path, compile=False)

    # st.title("Tumor Detection Using CNN")
    st.write(
        "A Convolutional Neural Network is a type of artificial neural network, which is widely used for image/object recognition and classification.")
